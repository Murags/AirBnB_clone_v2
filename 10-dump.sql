...
CREATE TABLE place_amenity (
    place_id VARCHAR(60) REFERENCES places (id) ON UPDATE CASCADE ON DELETE CASCADE,
    amenity_id VARCHAR(60) REFERENCES amenities (id) ON UPDATE CASCADE ON DELETE CASCADE,
